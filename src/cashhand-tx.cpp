...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CashHand Core cashhand-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cashhand-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cashhand transaction") + "\n" +
                               "  cashhand-tx [options] -create [commands]   " + _("Create hex-encoded cashhand transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cashhand transaction
