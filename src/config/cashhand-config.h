/* src/config/cashhand-config.h.  Generated from cashhand-config.h.in by configure.  */
/* src/config/cashhand-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_STRING "CashHand Core 1.2.4"
