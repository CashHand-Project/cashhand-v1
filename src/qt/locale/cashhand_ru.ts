...
<context>
    ...
    <message>
        ...
        <translation>Будут показаны не все транзакции. Для отображения всех транзакций необходимо выставить txindex=1 в конфигурационном файле (cashhand.conf).</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Этот вариант является самым быстрым и будет стоить порядка ~0.025 CHND для анонимизации 10000 CHND</translation>
    </message>
    <message>
        <source>This option is moderately fast and will cost about 0.05 CHND to anonymize 10000 CHND</source>
        <translation>Это средний по скорости вариант и он будет стоить около 0.05 CHND для анонимизации 10000 CHND</translation>
    </message>
    <message>
