                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CashHand Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CashHand address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cashhand: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CashHand Core"), this);
    aboutAction->setStatusTip(tr("Show information about CashHand Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CashHand"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CashHand addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CashHand addresses"));
    ...
    openAction->setStatusTip(tr("Open a CashHand: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CashHand Core help message to get a list with possible CashHand command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CashHand Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CashHand network", "", count));
}
...
{
    QString strTitle = tr("CashHand Core"); // default title
