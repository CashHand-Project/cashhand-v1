...
/** Utility functions used by the CashHand Qt UI.
 */
namespace GUIUtil
{
...
// Render CashHand addresses in monospace font
...
// Parse "cashhand:" URI into recipient object, return true on successful parsing
