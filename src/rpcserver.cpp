...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop CashHand server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "CashHand server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CashHand features */
        {"cashhand", "masternode", &masternode, true, true, false},
        {"cashhand", "masternodelist", &masternodelist, true, true, false},
        {"cashhand", "mnbudget", &mnbudget, true, true, false},
        {"cashhand", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"cashhand", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cashhand", "mnsync", &mnsync, true, true, false},
        {"cashhand", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"cashhand", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use cashhandd, or the -server option to cashhand-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> cashhand-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:17358/\n";
}
