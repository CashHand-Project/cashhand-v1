...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/Cashhand/cashhand/blob/master/doc/translation_process.md#synchronising-translations).
...
### Build and sign CashHand Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit cashhand=v${VERSION} ../cashhand/contrib/gitian-descriptors/gitian-win.yml
...
- Detached signatures will then be committed to the [cashhand-detached-sigs](https://github.com/Cashhand/cashhand-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/Cashhand/cashhand/releases/new) with a link to the archived release notes.
