...
In order to support loading of multiple wallets in cashhand-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cashhand.cpp.
...
Changes to cashhand.cpp
----------------------
cashhand.cpp is the entry point into cashhand-qt, and as such, will require some minor modifications to provide hooks for
