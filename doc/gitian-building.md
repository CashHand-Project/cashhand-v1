...
*Setup instructions for a gitian build of CashHand using a Debian VM or physical system.*
...
- [Building CashHand](#building-cashhand)
...
Clone the git repositories for cashhand and gitian and then checkout the cashhand version that you want to build.
...
Follow the instructions in [doc/release-process.md](release-process.md) in the cashhand repository
...
To build CashHand (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the cashhand repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/cashhand/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/Cashhand/cashhand
...
For example:
```bash
URL=https://github.com/crowning-/cashhand.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit cashhand=${COMMIT} --url cashhand=${URL} ../cashhand/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit cashhand=${COMMIT} --url cashhand=${URL} ../cashhand/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit cashhand=${COMMIT} --url cashhand=${URL} ../cashhand/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/cashhand-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/cashhand-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/cashhand-build.assert
```
...
[cashhand/gitian.sigs](https://github.com/Cashhand/gitian.sigs/) repository, or if that's not possible to create a pull
request.
