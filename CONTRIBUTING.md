Contributing to CashHand Core
============================

The CashHand Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CashHand Core project, and is not to be
confused with overall CashHand Network Protocol consensus changes.

Whether a pull request is merged into CashHand Core rests with the project merge
...
Patches that change CashHand consensus rules are considerably more involved than
...
Where a patch set proposes to change the CashHand consensus, it must have been
...
The project leader is the release manager for each CashHand Core release.
